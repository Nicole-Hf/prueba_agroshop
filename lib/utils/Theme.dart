...
class MaterialColors {
  ...
  static const Color primaryLight = Color(0xfffdf0e7);
  static const Color white = Colors.white;
  static const Color textGray = Color(0xff7e7e7e);
  static const Color black = Colors.black;
  static const Color iconGray = Color(0xffd5d5d5);
  static const Color lightBlue = Color.fromRGBO(40, 155, 212, 1);
  static const Color waterGreen = Color.fromRGBO(66, 209, 193, 1);
  static const Color lightGrey = Color.fromRGBO(247, 248, 251, 1);
  static const Color maastrichtBlue = Color.fromRGBO(29, 37, 64, 1);
  static const Color spanishGrey = Color.fromRGBO(157, 158, 159, 1);
  static const Color darkGreen = Color.fromRGBO(51, 122, 61, 1.0);
  static const Color darkRed = Color.fromRGBO(175, 76, 80, 1.0);
}
